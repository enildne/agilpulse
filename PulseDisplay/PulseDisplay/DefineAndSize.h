...
#define		MAX_INPUT_VALUE				200

#define		DRAW_TOP_PAD				0				// Grpah 화면의 상단 Padding
#define		DRAW_BOTTOM_PAD				0
#define		DRAW_LEFT_PAD				0
#define		DRAW_RIGHT_PAD				0
